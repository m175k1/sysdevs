...
<?php
    $cid=$_REQUEST['cid'];
    $sid=$_SESSION['sid'];
    $query=mysqli_query($con,"select * from sales natural join sales_details left join masterfile on sales_details.prod_id = masterfile.master_id where sales_id='$sid'")or die(mysqli_error());
      $grand=0;
...
<?php }?>     
            ...
            <div class="col-md-3">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <!-- Date range -->
                  <form method="post" name="autoSumForm" action="terms_add.php?cid=<?php echo $_GET['cid']; ?>">
          <div class="row">
           <div class="col-md-12">
<?php
$sid=$_SESSION['sid'];
...
?>        
              ...
              <label for="date">Downpayment</label>
                <input type="text" class="form-control" id="down" name="down" tabindex="6" placeholder="Downpayment" value="<?php /*$down=($grand+$interest)*.2;echo $down; */ echo 0;?>" required>
              </div><!-- /.form group -->
      ...
      <button class="btn btn-lg btn-block btn-success" id="" name="finish" onclick="" type="submit"  tabindex="7">
                        Finish
                      </button>
