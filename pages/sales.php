...
?>      
            ...
            <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
<?php
    $query=mysqli_query($con,"select * from sales a left join sales_details b on a.sales_id = b.sales_id left join masterfile c on b.prod_id = c.master_id left join customer d on a.cust_id = d.cust_id where date(date_added)>='$start' and date(date_added)<='$end' and a.branch_id='$branch'")or die(mysqli_error($con));
